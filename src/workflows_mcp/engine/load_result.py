...
- NodeMeta (ADR-009: universal node metadata for fractal for_each)
- ExecutionResult (workflow execution monad)
- BlockExecution (block execution result with NodeMeta)

Post ADR-006: Executors return BaseModel directly and raise exceptions.
Post ADR-009: NodeMeta provides fractal metadata structure.
"""
