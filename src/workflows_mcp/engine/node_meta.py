...
This module implements the __meta__ namespace that unifies regular blocks
and for_each iterations under a single, recursive structure.

Key Concepts:
- Regular blocks are for_each with count=1 (fractal design)
- Every node (block or iteration) has identical __meta__ structure
...
class NodeMeta(BaseModel):
    ...
    Usage:
        ...
        meta = NodeMeta.create_leaf_success(
            type="Shell",
            id="build",
            duration_ms=1234,
        ...
        meta = NodeMeta.create_for_each_parent(
            type="LLMCall",
            id="analyze_files",
    ...
    def create_leaf_success(
        ...
        **executor_fields: Any,
        ...
        Returns:
            NodeMeta with count=1, count_failed=0, count_skipped=0, mode=None
    ...
    def create_leaf_failure(
        ...
        **executor_fields: Any,
        ...
        Returns:
            NodeMeta with count=1, count_failed=1, count_skipped=0, mode=None
    ...
    def create_leaf_skipped(
        ...
        **executor_fields: Any,
        ...
        Returns:
            NodeMeta with count=1, count_failed=0, count_skipped=1, mode=None, duration_ms=0
    ...
    def create_leaf_paused(
        ...
        **executor_fields: Any,
        ...
        Note:
            Paused state is represented in checkpoint data, not directly in __meta__.
        ...
        Example:
            meta = NodeMeta.create_leaf_paused(
                type="Prompt",
                id="get_input",
                duration_ms=123,
                started_at="2025-11-04T10:30:00Z",
    ...
    def create_for_each_parent(
        ...
        Args:
            ...
            child_metas: List of child NodeMeta objects
        ...
        Returns:
            NodeMeta with aggregated counts from children

        Example:
            child1 = NodeMeta.create_leaf_success(...)
            child2 = NodeMeta.create_leaf_failure(...)
            parent = NodeMeta.create_for_each_parent(
                type="LLMCall",
                id="analyze_files",
                iterations={"file1": {...}, "file2": {...}},
